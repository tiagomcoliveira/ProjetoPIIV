...
<body>
    <div class="fundo">
        ...
        <div class="espacosolicalunos">
            ...
            <div class="btn_edit" onclick="Voltar()"><img src="imagens/Inscricoes.png" style="height: 15px"> Editar
            </div><br>
            <div class="btn_remover" onclick="Voltar()"><img src="imagens/reject2.png" style="height: 15px"> Eliminar
            </div>

            <br><br>
            <legend>Dados do Aluno</legend>
            <br>
            <input type="text" name="solicnomealuno" id="solicnomealuno" placeholder="nome do aluno"
                style="outline: none" readonly class="camponclubendocente">
            <br><br>
            <input type="text" name="solicanoaluno" id="solicanoaluno" placeholder="ano" style="outline: none" readonly
                class="campoiniciofimclube">
            <input type="text" name="solicturmaaluno" id="solicturmaaluno" placeholder="turma" style="outline: none"
                readonly class="campoiniciofimclube">
            <input type="text" name="solicturmaaluno" id="solicturmaaluno" placeholder="clubes" style="outline: none"
                readonly class="campoiniciofimclube">
            <br><br>
            <input type="text" name="solicturmaaluno" id="solicturmaaluno" placeholder="email do DT" style="outline: none;"
                readonly class="campoemailDT">
                <br><br>
                <textarea name="solicobsaluno" class="corpo" rows="8" placeholder="observações" readonly
                style="outline: none"></textarea>
                <div class="btn_entrar"><a href="avaliacoes.html" type="submit" style="color: #FFFFFF; vertical-align: middle;">Avaliações</a></div>
        </div>
        <br><br><br><br>
