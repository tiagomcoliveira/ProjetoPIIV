...
<body>
    <div class="fundo">
        ...
        <div class="espaconoticia">
            ...
            <br>
            <input type="text" name="utilizador" id="titulo" placeholder="título" style="outline: none" required
                class="campotitulo">
            <input type="date" name="data" id="datanoticia" placeholder="data" style="outline: none; font-weight: bold;"
                required class="campodata">
            <br><br>
            <textarea name="mensagem" class="corpo" rows="8" placeholder="corpo" required
