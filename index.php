...
<head>
    <meta charset="UTF-8">
    <title>BackOffice - APP ESV</title>
...
<body>
    <div class="fundo">
        <div class="centrarindex">
            <img src="imagens/Logo.svg" alt="Logo Escola Secundária de Viriato" />
        </div>
        <br><br>
        <div class="btn_inisess"><a href="login.php">Iniciar Sessão &#10097;</a></div>
        <br><br><br><br>
        <br><br>
