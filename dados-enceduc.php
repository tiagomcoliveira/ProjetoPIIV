...
<body>
    <div class="fundo">
        ...
        <div class="espacosolicalunos">
            ...
            <br><br>
            <legend>Dados do Encarregado de Educação</legend>
            <br>
            <input type="text" name="solicnomealuno" id="solicnomealuno" placeholder="nome do aluno" style="outline: none" readonly
