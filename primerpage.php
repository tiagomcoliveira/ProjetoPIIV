    ...
    <div class="fundo">
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-light sticky-top">
            <div class="container-fluid">
                <a class="navbar-brand" href="#"><img src="imagens/Logotipo.png" style="height: 5vh"></a>
        ...
        <section class="container">
            <div class="espacoaddclube">
                <div>
                    <a href="adicionarclube.html" style="text-decoration: none; color: #FFFFFF;">
                        <p><img style="vertical-align:middle" width="50px" height="50px" src="imagens/bt_add.png">
                            Adicionar
                            Clube</p>
                    </a>
                </div>
            ...
            <div class="espacocriarinscricao">
                <div>
                    <a href="criarinscricao.html" style="text-decoration: none; color: #FFFFFF;">
                        <p><img style="vertical-align:middle" width="50px" height="50px" src="imagens/bt_add.png"> Criar
                            Inscrição</p>
                    </a>
                </div>
            </div>
        ...
        <br><br>
        <div class="espacoaddnoticia">
            <div>
                <a href="adicionarnoticia.html" style="text-decoration: none; color: #FFFFFF;">
                    <p><img style="vertical-align:middle" width="50px" height="50px" src="imagens/bt_add.png"> Adicionar
                        Notícia</p>
                </a>
            </div>
        </div>
