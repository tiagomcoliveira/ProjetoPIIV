...
<head>
    <meta charset="UTF-8">
    <title>BackOffice - Lista de Notícias</title>
...
<body>
    <div class="fundo">
        ...
        <div class="espacosolicitacoes">
            <legend>Lista de Notícias</legend>
            <br>
            <div class="search-box">
                <input class="input-box" id="filtrar" type="text" name="" onkeyup="Filtrar()"
            ...
            <table id="fltTabela">
                <tr>
                    <th style="width: 300px; font-size: 26px;" onclick="Ordenar(0)"><div class="sortAlunoProfEnc">Título &#9662;</div></th>
                    <th style="width: 200px; font-size: 26px;" onclick="Ordenar(1)"><div class="sortAlunoProfEnc">Data &#9662;</div></th>
                    <th style="width: 100px; text-align: center; font-size: 26px;">Operações</th>
                </tr>
                <tr>
                    <td>São Martinho na ESV</td>
                    <td>13/11/2019</td>
                    <td>
                        <button id="accept">
                            <img src="imagens/Inscricoes.png" alt="" height=15 width=15
                    ...
                    <td style="width: 100px; text-align: right;">
                        <button id="reject">
                            <img src="imagens/reject2.png" alt="" height=15 width=15 style="vertical-align: middle;" />
                            Remover
                        </button>
                    </td>
                </tr>
                <tr>
                    <td>Carnaval na ESV</td>
                    <td>25/02/2019</td>
                    <td>
                        <button id="accept">
                            <img src="imagens/Inscricoes.png" alt="" height=15 width=15
                ...
                <tr>
                    ...
                    <td>12/12/2019</td>
                    <td>
                        <a style="text-decoration: none;" href="editar-noticia.html">
                        <button id="accept">
                            <img src="imagens/Inscricoes.png" alt="" height=15 width=15
                                style="vertical-align: middle;" />
                            Editar
