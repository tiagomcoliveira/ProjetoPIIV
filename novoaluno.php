...
<head>
    <meta charset="UTF-8">
    <title>BackOffice - Novo Aluno</title>
...
<body>
    <div class="fundo">
        ...
        <div class="espacosolicalunos">
            ...
            <input type="text" name="NOME_USER" id="NOME_USER" placeholder="nome do aluno"
                style="outline: none" class="camponclubendocente">
            <br><br>
            <input type="text" name="ANO_USER" id="ANO_USER" placeholder="ano" style="outline: none"
                class="campoiniciofimclube">
            <input type="text" name="TURMA_USER" id="TURMA_USER" placeholder="turma" style="outline: none"
             class="campoiniciofimclube">
            <br><br>
            <input type="text" name="EMAIL_USER" id="EMAIL_USER" placeholder="email do DT" style="outline: none;"
             class="campoemailDT">
                <br><br>
                <input id="btncriar" type="submit" value="Criar" class="btn_criar" style="outline: none">
